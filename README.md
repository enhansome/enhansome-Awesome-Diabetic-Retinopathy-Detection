# Awesome Diabetic-Retinopathy-Detection with stars
...
| --------------------------------------------------------------------------------------------------------------------------- | ---- | ------- | ------ | -------------------- | ------------------------------------ | ------------- | ------------------ | --------------------------------------------------------------------------------------------------- |
| [GDRBench](https://github.com/chehx/DGDR/blob/main/GDRBench/README.md) ⭐ 54 \| 🐛 3 \| 🌐 Jupyter Notebook \| 📅 2026-04-04 | 2023 | 111,357 | /      | /                    | /                                    | /             | Multiple Institues | Domain Generalization in DR Grading (DGDR)                                                          |
...
| [DDR](https://github.com/nkicsl/DDR-dataset) ⭐ 130 \| 🐛 6 \| 📅 2024-11-01                                                 | 2019 | 13673   | jpg    | Topcon, Nikon, Canon | /                                    | 45°           | Nankai             | DR grading / Lesion segmentation/detection                                                          |
...
* A deep learning system for predicting time to progression of diabetic retinopathy
  ...
  [\[code\]](https://github.com/drpredict/DeepDR_Plus) ⭐ 55 | 🐛 3 | 🌐 Python | 📅 2023-09-20
...
* RetiGen: A Framework for Generalized Retinal Diagnosis Using Multi-View Fundus Images
  ...
  [\[code\]](https://github.com/zgy600/RetiGen) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2024-07-15
...
* Towards Generalizable Diabetic Retinopathy Grading in Unseen Domains
  ...
  [\[code\]](https://github.com/chehx/DGDR) ⭐ 54 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-04
  * Haoxuan Che, Yuhan Cheng, Haibo Jin, Hao Chen. *MICCAI 2023*

* Image Quality-aware Diagnosis via Meta-knowledge Co-embedding
  [\[pdf\]](https://arxiv.org/abs/2303.15038)
  [\[code\]](https://github.com/chehx/MKCNet) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2023-05-27
...
* Diabetic Retinopathy Grading with Weakly-Supervised Lesion Priors
  ...
  [\[code\]](https://github.com/FDU-VTS/LANet) ⭐ 10 | 🐛 1 | 🌐 Python | 📅 2025-01-11
...
* Lesion-Aware Contrastive Learning for Diabetic Retinopathy Diagnosis
  ...
  [\[code\]](https://github.com/IntelliDAL/Image) ⭐ 5 | 🐛 2 | 🌐 Python | 📅 2024-02-23
...
* SSiT: Saliency-guided Self-supervised Image Transformer for Diabetic Retinopathy Grading
  ...
  [\[code\]](https://github.com/YijinHuang/SSiT) ⭐ 35 | 🐛 1 | 🌐 Python | 📅 2024-12-05
...
* Cross-Field Transformer for Diabetic Retinopathy Grading on Two-field Fundus Images
  ...
  [\[code\]](https://github.com/FDU-VTS/DRTiD) ⭐ 29 | 🐛 2 | 🌐 Python | 📅 2024-05-28
...
* Deep-OCTA: Ensemble Deep Learning Approaches for Diabetic Retinopathy Analysis on OCTA Images
  ...
  [\[code\]](https://github.com/FDU-VTS/DRAC) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2024-03-05
...
* Focused Attention in Transformers for interpretable classification of retinal images
  ...
  [\[code\]](https://github.com/ClementPla/FocusedAttention) ⭐ 5 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-07-01
...
* Lesion-Based Contrastive Learning for Diabetic Retinopathy Grading from Fundus Images
  ...
  [\[code\]](https://github.com/YijinHuang/Lesion-based-Contrastive-Learning) ⭐ 46 | 🐛 0 | 🌐 Python | 📅 2024-06-28
...
* Rotation-oriented Collaborative Self-supervised Learning for Retinal Disease Diagnosis
  ...
  [\[code\]](https://github.com/xmengli/Rotation-oriented-self-supervised) ⭐ 17 | 🐛 11 | 🌐 Python | 📅 2023-02-15
...
* Self-Supervised Feature Learning via Exploiting Multi-Modal Data for Retinal Disease Diagnosis
  ...
  [\[code\]](https://github.com/xmengli/self_supervised) ⭐ 55 | 🐛 12 | 🌐 Python | 📅 2023-02-15
...
* CABNet: Category Attention Block for Imbalanced Diabetic Retinopathy Grading
  ...
  [\[code\]](https://github.com/he2016012996/CABnet) ⭐ 41 | 🐛 8 | 🌐 Python | 📅 2023-06-05
...
* Automated lesion segmentation in fundus images with many-to-many reassembly of features
  ...
  [\[code\]](https://github.com/CVIU-CSU/M2MRF-Lesion-Segmentation) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2023-02-21
...
* Optimal Transport Guided Unsupervised Learning for Enhancing low-quality Retinal Images
  ...
  [\[code\]](https://github.com/retinal-research/ote-gan) ⭐ 67 | 🐛 1 | 🌐 Python | 📅 2023-12-27
...
* Learning Enhancement From Degradation: A Diffusion Model For Fundus Image Enhancement
  ...
  [\[code\]](https://github.com/QtacierP/LED) ⭐ 44 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2024-04-13
...
* OTRE: Where Optimal Transport Guided Unpaired Image-to-Image Translation Meets Regularization by Enhancing
  ...
  [\[code\]](https://github.com/Retinal-Research/OTRE) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2025-08-02
...
* Structure-Consistent Restoration Network for Cataract Fundus Image Enhancement
  ...
  [\[code\]](https://github.com/liamheng/ArcNet-Medical-Image-Enhancement) ⭐ 42 | 🐛 1 | 🌐 Python | 📅 2024-06-12
...
* An Annotation-Free Restoration Network for Cataractous Fundus Images
  ...
  [\[code\]](https://github.com/liamheng/Annotation-free-Fundus-Image-Enhancement) ⭐ 42 | 🐛 1 | 🌐 Python | 📅 2024-06-12
...
* DOMAIN GENERALIZATION IN RESTORATION OF CATARACT FUNDUS IMAGES VIA HIGH-FREQUENCY COMPONENTS
  ...
  [\[code\]](https://github.com/HeverLaw/Restoration-of-Cataract-Images-via-Domain-Generalization) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2022-03-29
...
* I-SECRET: Importance-Guided Fundus Image Enhancement via Semi-supervised Contrastive Constraining
  ...
  [\[code\]](https://github.com/QtacierP/ISECRET) ⭐ 29 | 🐛 2 | 🌐 Python | 📅 2024-02-27
...
* \[[EyePACS](https://github.com/YijinHuang/pytorch-classification) ⭐ 70 | 🐛 2 | 🌐 Python | 📅 2025-09-19] Identifying the key components in ResNet-50 for diabetic retinopathy grading from fundus images: a systematic investigation
